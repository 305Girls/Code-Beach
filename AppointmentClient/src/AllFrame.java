...
public class AllFrame {
	...
	public AllFrame(){
		...
		mframe.getBtnNewButton().addMouseListener(new MouseListener(){//预约
			@Override
		...
		iframe.getBtnNewButton().addMouseListener(new MouseListener(){//下一步
			@Override
		...
		iframe.getBtnNewButton_1().addMouseListener(new MouseListener(){//返回
			@Override
			public void mouseClicked(MouseEvent arg0) {
				// TODO Auto-generated method stub
				Object[] options = { "是", "否" }; 
		...
		a1frame.getBtnNewButton().addMouseListener(new MouseListener(){//确定
			@Override
			public void mouseClicked(MouseEvent arg0) {
				// TODO Auto-generated method stub
        ...
        a1frame.getBtnNewButton_1().addMouseListener(new MouseListener(){//取消
			@Override
			public void mouseClicked(MouseEvent e) {
				// TODO Auto-generated method stub
				Object[] options = { "是", "否" }; 
        ...
        a2frame.getBtnNewButton_1().addMouseListener(new MouseListener(){//取消
			@Override
			public void mouseClicked(MouseEvent e) {
				// TODO Auto-generated method stub
				Object[] options = { "是", "否" }; 
